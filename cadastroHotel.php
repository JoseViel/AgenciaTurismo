    ...
    <div class="form-container">
        <div class="form-screen">
            <div class="form-screen__content">
                <form class="form-login" action="insHotel.php" method="POST">
                    ...
                    <div class="form-login__field">
                        <i class="form-login__icon fa-solid fa-location-dot"></i>
                            <input type="text" class="form-login__input" name="endereco" id="endereco" placeholder="Endereço" required>
                    </div>
                    <div class="form-login__field">
                        <i class="form-login__icon fa-solid fa-star"></i>
                            <input type="text" class="form-login__input" name="classificacao" id="classificacao" placeholder="Classificação" required>
                    </div>
