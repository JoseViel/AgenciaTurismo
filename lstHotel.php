    ...
    <div class="container">
        <div class="row">
            <div class="col s12">
                ...
                <a class="btn-floating btn-large waves-effect waves-light green" onclick="JavaScript:location.href='cadastroHotel.php'"><i class="material-icons">add</i></a>

                <div class="row">
                    <div class="input-field">
                        <form action="lstHotel.php" method="GET" id="frmBuscaHotel" class="col s12">
                ...
                <table class="striped highlight blue-grey lighten-3 responsive-table">
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo $hotel['classificacao']; ?></td>
                            <td> <a class="btn-floating btn-small waves-effect waves-light green" onclick="JavaScript:location.href='frmEdtHotel.php?id=' +
                          <?php echo $hotel['id']; ?>">
                                    <i class="material-icons">edit</i>
                            </td>
                            <td> <a class="btn-floating btn-small waves-effect waves-light red" onclick="JavaScript:remover(<?php echo $hotel['id']; ?>)">
...
<script>
    function remover(id) {
        if (confirm('Excluir o hotel ' + id + '?')) {
            location.href = 'remHotel.php?id=' + id;
        }
    }
...
//tecla enter
    ...
    function searchData (){
        window.location = 'lsthotel.php?search='+search.value;
    }
</script>